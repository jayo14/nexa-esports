-- Add allow_sunday_withdrawals setting
INSERT INTO public.clan_settings (key, value, description)
VALUES ('allow_sunday_withdrawals', false, 'Allow withdrawals on Sundays')
ON CONFLICT (key) DO NOTHING;

-- Update execute_user_transfer to include wallet_state
