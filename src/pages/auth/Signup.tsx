            ...
            <div className="space-y-5">
              ...
              <div className="relative my-6">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-card px-2 text-muted-foreground font-rajdhani tracking-widest">or enlist via satellite</span>
                </div>
              </div>
              ...
              <Button
                ...
                disabled={loading}
                className="w-full h-14 rounded-xl text-lg font-bold font-rajdhani border-border/30 hover:bg-white/5 text-foreground bg-transparent flex items-center justify-center gap-3 transition-all"
              >
