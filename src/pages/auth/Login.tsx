        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="p-3 xs:p-4 sm:p-8 bg-white/12 backdrop-blur-2xl rounded-2xl xs:rounded-3xl border border-white/25 shadow-2xl glass-card">
            <div className="space-y-5">
              ...
              <div className="relative my-6 px-1 xs:px-2 sm:px-4">
                <div className="absolute inset-0 flex items-center">
                  <span className="w-full border-t border-white/10" />
                </div>
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-[#1a1a1a] px-2 text-white/40 font-rajdhani tracking-widest bg-clip-border">or join via satellite</span>
                </div>
              </div>
              ...
              <Button
                ...
                disabled={loading}
                className="w-full h-10 xs:h-12 sm:h-14 rounded-lg xs:rounded-xl text-base xs:text-lg font-bold font-rajdhani border-white/20 hover:bg-white/5 text-white bg-transparent flex items-center justify-center gap-3 transition-all"
              >
