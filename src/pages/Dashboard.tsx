...
export const Dashboard: React.FC = () => {
  ...
  return (
    <>
      {/* Responsive Header */}
      <header className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-0 px-2 sm:px-4 md:px-6 py-4 w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6 px-2 sm:px-4 md:px-6">
        {/* Hero Section */}
        <section className="col-span-1 md:col-span-8 relative h-[220px] xs:h-[280px] sm:h-[320px] md:h-[420px] rounded-2xl md:rounded-[3rem] overflow-hidden group mb-4 md:mb-0">
          <img
            alt="Hero"
          ...
          <div className="relative h-full flex flex-col justify-center p-4 xs:p-6 sm:p-8 md:p-12 max-w-xl gap-4 sm:gap-6">
            ...
            <h2 className="text-3xl xs:text-4xl sm:text-5xl md:text-6xl font-display font-bold text-white tracking-tight leading-none uppercase">
              Elite <br />Commando
            </h2>
        ...
        <div className="col-span-1 md:col-span-4 flex flex-col gap-2 sm:gap-3 md:gap-4 mt-0">
          {/* Quick Actions */}
          <button
          ...
          >
            <div className="flex items-center gap-3 sm:gap-4">
              <span className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-br from-accent-red/40 to-primary/30 flex items-center justify-center">
                <Wallet className="w-7 h-7 sm:w-8 sm:h-8 text-white" />
              </span>
              <div>
                <h4 className="font-bold text-xs sm:text-sm text-white font-sans">Wallet</h4>
                <p className="text-white/40 text-[11px] sm:text-xs mt-1 font-sans">Manage your funds</p>
              </div>
            </div>
          ...
          >
            <div className="flex items-center gap-3 sm:gap-4">
              <span className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-br from-indigo-500/40 to-primary/30 flex items-center justify-center">
                <ShoppingCart className="w-7 h-7 sm:w-8 sm:h-8 text-white" />
              </span>
              <div>
                <h4 className="font-bold text-xs sm:text-sm text-white font-sans">Marketplace</h4>
                <p className="text-white/40 text-[11px] sm:text-xs mt-1 font-sans">Buy and sell assets</p>
              </div>
            </div>
            <ChevronRight className="w-5 h-5 text-white/30 group-hover:text-white transition-colors" />
          </button>
          ...
          >
            <div className="flex items-center gap-3 sm:gap-4">
              <span className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-br from-amber-400/40 to-primary/30 flex items-center justify-center">
                <CalendarCheck className="w-7 h-7 sm:w-8 sm:h-8 text-white" />
              </span>
              <div>
                <h4 className="font-bold text-xs sm:text-sm text-white font-sans">Attendance</h4>
                <p className="text-white/40 text-[11px] sm:text-xs mt-1 font-sans">Mark your presence</p>
              </div>
            </div>
            <ChevronRight className="w-5 h-5 text-white/30 group-hover:text-white transition-colors" />
          </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-8 items-start mb-4 px-2 sm:px-4 md:px-6">
        {/* New Operations */}
        <div className="col-span-1 md:col-span-8">
          <div className="flex flex-col xs:flex-row xs:items-center xs:justify-between mb-4 sm:mb-6 gap-2 xs:gap-0">
          ...
          <div className="flex gap-4 sm:gap-6 overflow-x-auto pb-2 sm:pb-4 custom-scrollbar">
            {allEvents.length > 0 ? allEvents.map((event, i) => (
              <div key={event.id} className="min-w-[220px] xs:min-w-[260px] sm:min-w-[300px] h-[220px] xs:h-[260px] sm:h-[360px] glass-card rounded-2xl sm:rounded-[3rem] p-4 sm:p-6 flex flex-col justify-end relative group cursor-pointer shadow-xl overflow-hidden" onClick={() => navigate(`/events/${event.id}`)}>
                ...
                <div className="relative z-10">
                  <h4 className="text-lg sm:text-2xl font-bold mb-1 sm:mb-2 text-white font-display">{event.name}</h4>
        ...
        <div className="col-span-1 md:col-span-4 mt-4 md:mt-0">
          ...
          <div className="glass-card rounded-2xl sm:rounded-[3rem] p-6 sm:p-8 flex flex-col items-center gap-6 sm:gap-8 border border-white/10 shadow-2xl relative overflow-hidden h-[220px] xs:h-[260px] sm:h-[360px] justify-center">
            <div className="relative w-28 h-28 xs:w-36 xs:h-36 sm:w-44 sm:h-44 flex items-center justify-center">
              ...
              <div className="absolute flex flex-col items-center justify-center text-center">
                <p className="text-white/40 text-[9px] xs:text-[10px] uppercase font-bold tracking-widest font-sans">Total Wins</p>
                <span className="text-xl xs:text-2xl sm:text-3xl font-display font-bold text-white">12,340</span>
              </div>
            </div>
            <div className="grid grid-cols-3 w-full gap-1 xs:gap-2">
              {[
                ...
                return (
                  <div key={i} className="flex flex-col items-center gap-0.5 xs:gap-1">
                    <div className={cn("w-7 h-7 xs:w-8 xs:h-8 rounded-full flex items-center justify-center border", item.bg, item.border)}>
                      <Icon className={cn("w-4 h-4 fill-current", item.color)} />
                    </div>
                    <span className="text-[9px] xs:text-[10px] font-bold text-white font-sans">{item.label}</span>
                  </div>
                );
              })}
            </div>
